...
then cpu er program counter ram er next exicutable sell ke poin kore thake 
then controll unit ase dekhe program counter kake point kore ase then controll unit dekhe j nirdisto akta cell ke poin kore ase (aikhane poin kore ase mane program counter er moddhe oi cell er adress ta rakha ase pore se adress controll unit follow kore fetch kore) tokhon poin kora cell er code controll unit ane ta instruction register e rakhe ar sate sate program counter er value ak barai dei
then controll unit instruction register er coman gulo exicute kore ar coman er bivinno onshoke al bl cl e rakhe
then controll unit pointer regidter ke bole al bl cl niye kaj korte o opraration calai then kono result pele ta dl e rekhe dei
